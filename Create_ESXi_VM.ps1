...
$VMAutostart = $false
$VMTurnOn = $true
$VMGuestID = "windows9Server64Guest" #Default is Server 2016 - Sets NIC and SCSI adapter type, ref https://www.vmware.com/support/developer/windowstoolkit/wintk40u1/html/New-VM.html
